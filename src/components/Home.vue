      ...
      <div class="row align-items-center">
        <table class="table">
          ...
          <tr>
            ...
            <td>localhost:3231</td>
            <td><span class="badge badge-success">ONLINE</span></td>
            <td>[1, 4, 32]</td>
            <td class="text-right">32</td>
            <td class="td-actions text-right">
              <button type="button" rel="tooltip" class="btn btn-primary btn-sm " data-original-title="" title=""> ADD
              </button>
              <button type="button" rel="tooltip" class="btn btn-primary btn-sm " data-original-title="" title=""> REMOVE
              </button>
              <button type="button" rel="tooltip" class="btn btn-danger btn-icon btn-sm " data-original-title="" title=""> OFF
